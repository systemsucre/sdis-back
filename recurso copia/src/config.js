...
export const DB_DATABASE = process.env.DB_DATABASE || 'sids1';
export const DB_PORT = process.env.DB_PORT || 3306;
export const KEY = process.env.KEY || 'KEY2023'
export const CLAVEGMAIL = process.env.CLAVEGMAIL || 'frqhuvfcwdccomfh'

// export const DB_HOST = process.env.DB_HOST || 'sedeschuquisaca.gob.bo';
// export const DB_USER = process.env.DB_USER || 'sedes_rian';
// export const DB_PASSWORD = process.env.DB_PASSWORD || 'Ag//5556//zxzx';
// export const DB_DATABASE = process.env.DB_DATABASE || 'sedes_sdis1';
// export const DB_PORT = process.env.DB_PORT || 3306;
// export const KEY = process.env.KEY || 'KEY2023'
// export const CLAVEGMAIL = process.env.CLAVEGMAIL || 'frqhuvfcwdccomfh'
