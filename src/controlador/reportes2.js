...
rutas.post("/listargestion", async (req, res) => {
    try {
        const resultado = await reportes2.listarGestion()
...
rutas.post("/listarvariableinicio", async (req, res) => {
    ...
    try {
        const resultado = await reportes2.listarVariableinicio()
        return res.json({ data: resultado, ok: true })
    } catch (error) {
        console.log(error)
        return res.json({ msg: 'Error en el servidor', ok: false })
...
rutas.post("/listarvariable", id, async (req, res) => {
    ...
    try {
        const resultado = await reportes2.listarVariable(req.body.id)
        return res.json({ data: resultado, ok: true })
    } catch (error) {
        console.log(error)
        return res.json({ msg: 'Error en el servidor', ok: false })
...
rutas.post("/unavariable", async (req, res) => {
    try {
        ...
        const resultado = await reportes2.listarDatosTodosVariable(datos)
        return res.json({ data: resultado, ok: true })
    } catch (error) {
        console.log(error)
        return res.json({ msg: 'Error en el servidor', ok: false })
...
rutas.post("/indicadorespecifico", async (req, res) => {
    try {
        ...
        const resultado = await reportes2.listarDatosVariableElegido(datos)
        return res.json({ data: resultado, ok: true })
    } catch (error) {
        console.log(error)
        return res.json({ msg: 'Error en el servidor', ok: false })
